          ...
          <div className="flex flex-wrap space-y-4 md:space-y-0 ">
            ...
            <div className="w-full md:w-[65%] px-2 space-y-4">
              ...
              <div className="bg-white rounded-md p-4 space-y-4">
                ...
                Jalan Kelapa Raya Komp. rispa 4 no. 11 residential buildings in Johor,
                  Medan Johor, Medan 20144 (brown fence house with trees
                  banyan), Medan Johor, Medan City, North Sumatra,
                  6282160945033
                </div>
